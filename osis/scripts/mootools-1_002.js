...
});}if(Browser.Engine.trident){if(a.window!=null){a.window.attachEvent("onunload",function(){if(a.window!=null){a.window.detachEvent("onunload",arguments.callee);a.head=a.html=a.window=null;
